...
if (isset($_POST['submit'])){
   ...
   mysqli_query($con,"insert into `order`(user_id,address,city,pincode,payment_type,payment_status,order_status,total_price,added_on) 
                                        ...
                                        <div class="accordion__body">
                                            <div class="paymentinfo">
                                                <div class="single-method">
                                                    ...
                                                    &nbsp; &nbsp;PayU(Payment on Card)<input type="radio" name="payment_type" value="payu" required />
                                                </div>
                                                <div class="single-method">
